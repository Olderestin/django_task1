...
from team.tests.fixtures import client, team_data

#positive case
@pytest.mark.django_db
def test_create_team(client: client, team_data: team_data) -> None:
...
@pytest.mark.django_db
def test_retrieve_team(client: client, team_data: team_data) -> None:
    for data in team_data:
...
@pytest.mark.django_db
def test_update_team(client: client, team_data: team_data) -> None:
...
@pytest.mark.django_db
def test_delete_team(client: client, team_data: team_data) -> None:   
    for data in team_data:
        team = Team.objects.create(title=data['title'], description=data['description'])
...
#negative case
@pytest.mark.django_db
def test_create_team_missing_required_fields(client: client, team_data: team_data) -> None:
    for data in team_data:    
...
@pytest.mark.django_db
def test_update_nonexistent_team(client: client, team_data: team_data) -> None:
    for data in team_data:    
